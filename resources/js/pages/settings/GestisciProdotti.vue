<template>
  ...
  <PageSection>
    <v-list lines="one">
      ...
      <v-list-item
        v-for="prodotto in prodottiStore.all"
        :key="prodotto.id"
        :title="prodotto.name"
        :subtitle="prodotto.code"
        prepend-avatar=""
      >
        <template v-slot:prepend>
          <v-img
            v-if="prodotto.default_images"
            color="grey-lighten-1"
            :src="prodotto.default_images.src"
            :height="50"
            :width="50"
          >
          </v-img>
      ...
      <v-list-item key="new">
        <v-btn
          ...
          color="primary"
          @click="handleAggiungiNuovoProdotto"
