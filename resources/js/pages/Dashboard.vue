...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="grid grid-cols-2 h-screen lg:max-w-6xl p-5 mx-auto bg-white/20 rounded-lg text-black"
            style="grid-template-columns: 250px 1fr">
            <div class="">
                <ul class="mt-24">
                    <li><a href="#personal">Dati personali</a></li>
                </ul>

            </div>
            <div class="grid grid-cols-1 divide-y overflow-scroll">
                <section id="personal"
                    ...
                    <div class="flex flex-col md:flex-row">
                        <div class="flex flex-col grow-[10vw]">
                            ...
                            <div class="flex flex-row">
                                ...
                                <div class=" bg-green-700 rounded-full p-1 h-fit w-fit"
                                    :class="{ hidden: successName }"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
