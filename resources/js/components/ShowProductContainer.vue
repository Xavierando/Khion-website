<template>
    <v-container class="mx-auto">
        <v-row class="w-100">
            <v-col sm="3" cols="12" class="tw:transition-all tw:duration-500"> <v-card class="elevation-0">
                    <v-row dense>
            ...
            <v-col sm="9" cols="12" class="tw:transition-all tw:duration-500">
                <v-card class="elevation-0">
                    ...
                    <v-card-subtitle class="ga-2 d-flex flex-wrap">
                        <v-chip class="text-subtitle-1" v-for="tag in prodotto.tags" :key="tag.id">{{ tag.tag
                        }}</v-chip>
                    </v-card-subtitle>
